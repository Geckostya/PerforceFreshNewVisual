...
- Before changing skills, `AGENTS.md`, or documentation structure, follow `Docs/DOCUMENTATION_POLICY.md`; keep detailed rules in one owning document and load contracts progressively.
