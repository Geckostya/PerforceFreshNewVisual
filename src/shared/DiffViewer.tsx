...
export function DiffViewer({ text, truncated, binary, invalidEncoding }: { text: string; truncated?: boolean; binary?: boolean; invalidEncoding?: boolean }) {
  const { t } = useLocale();
